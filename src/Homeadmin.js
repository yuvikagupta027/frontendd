...
export default function Homeadmin() {
    return (
        <>
            ...
            {/* <div className="row m-0 bghomeadmin vh-100 align-items-center justify-content-around">
                <div className="col-lg-5 card p-0">
                    <form className="p-3">
                        <h5 className="fw-bold text-center">Add the item in Menucard</h5>
                ...
                <div className="col-lg-3 card p-0">
